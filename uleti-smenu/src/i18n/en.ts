const en = {
  ...
  settings: {
    title: "Settings",
    subtitle: "Manage your account security and personal preferences.",
    ...
    passwordChangeError: "We could not change your password. Check your current password and try again.",
    ...
    notifyEmailFavouriteJobPostDescription: "Get an email when a restaurant you follow posts a new shift.",
    notifyInAppFavouriteJobPost: "New jobs from favourite restaurants",
    notifyInAppFavouriteJobPostDescription: "Show a bell notification when a favourite restaurant posts a new shift.",
    notifyInAppApplicationAccepted: "Application accepted",
    notifyInAppApplicationAcceptedDescription: "When an employer accepts your application.",
    notifyInAppApplicationDeclined: "Application declined",
    ...
    privacy: "Privacy",
    privacyDescription: "Control the visibility and use of your account data.",
    logout: "Log out",
    logoutDescription: "End the current session on this device.",
  ...
  candidateShifts: {
    title: "My shifts",
    subtitle: "Shifts where your application was accepted.",
    empty: "You do not have accepted shifts yet.",
    accepted: "Accepted",
    archived: "Completed",
    upcoming: "Upcoming",
    openChat: "Message",
    chatClosed: "Closed",
    chatUnavailable: "Chat for this shift is not available yet.",
    loadError: "We could not load your shifts.",
    filters: "Filters",
    filtersSubtitle: "Choose restaurant, status, or display order.",
    ...
    sortSalaryDesc: "Highest wage",
    resetFilters: "Reset filters",
    showResults: "Show results ({{count}})",
    loadMore: "Load more"
  },
  candidateDashboard: {
    statsAriaLabel: "Candidate statistics",
    ...
    openChat: "Open chat",
    noUpcomingShift: "You do not have upcoming shifts.",
    noRecommendedJobs: "There are currently no recommended jobs in your city."
  },
  employerShell: {
  ...
  home: {
    ...
    shiftPreviewTitle: "Your shifts preview",
    shiftPreviewSubtitle: "A quick preview of accepted shifts.",
    shiftPreviewCta: "View all",
    shiftPreviewStatus: {
      completed: "Completed",
      accepted: "Confirmed",
      upcoming: "Upcoming"
  ...
  info: {
    ...
    forCandidates: {
      ...
      howItWorksText: "Browse active shifts, open a post that fits you, and apply. When a restaurant accepts your application, you can coordinate details through messages.",
      ...
      chatTitle: "How chat works",
      chatText: "Chat opens only after a restaurant accepts your application, so you can agree shift details.",
      reviewsTitle: "How reviews work",
      reviewsText: "Reviews help candidates and restaurants build trust after successfully completed shifts.",
  ...
  passwordReset: {
    ...
    requestError: "We could not send the reset link. Please try again.",
    resetTitle: "Enter a new password",
  ...
  registration: {
    ...
    passwordDigit: "Must have at least one number",
  ...
  jobPostManage: {
    ...
    actionActivate: "Activate job post",
    actionActivateDesc: "Publish this draft and move it to active job posts.",
    ...
    actionDeleteDisabledDesc: "This post has candidates. Archive it to preserve history.",
    activateSuccess: "Job post activated.",
    activateError: "Could not activate the job post. Check required fields.",
  ...
  billing: {
    ...
    selectPaymentMethodShort: "Choose payment method >",
    ...
    paymentChoiceTitle: "Choose a payment method",
    paymentChoiceIntro: "Choose the method that best fits you. You can always change it later.",
    payPerPostTitle: "Pay per post",
    payPerPostIntro: "Top up your wallet and pay only when you publish individual job posts.",
    payPerPostChoiceDescription: "Pay only when you publish a job post.",
    payPerPostBenefits: {
      topUp: "Top up your wallet when needed",
      noMonthly: "No monthly commitment",
      occasional: "Ideal for occasional job posts"
    },
    subscriptionPathTitle: "Subscription",
    subscriptionPathIntro: "Choose a monthly plan if you publish jobs regularly.",
    subscriptionChoiceDescription: "Publish jobs without paying for each individual post.",
    subscriptionBenefits: {
      morePosts: "Unlimited or increased job posts",
      support: "Priority support",
      value: "Better value for regular hiring"
    },
    continue: "Continue",
    viewPackages: "View packages",
    paymentMethodChangeNote: "You can change the payment method at any time.",
    walletFlowTitle: "Wallet top-up",
    walletFlowSubtitle: "Top up your wallet and pay only when you publish a job post.",
    ...
    secureStripe: "Secure online payment via Stripe.",
    ...
    subscriptionFlowTitle: "Choose package",
    subscriptionFlowSubtitle: "Publish jobs throughout your package period.",
    subscriptionRenewalNote: "The package renews automatically every month. You can cancel at any time.",
    recommendedPackage: "Most popular",
    currentPlan: "Current plan",
    selectPlan: "Select plan",
    activeSubscription: {
      title: "Your active subscription",
      subtitle: "Review your current package and manage subscription settings.",
      activeBadge: "Active",
      nextRenewal: "Next renewal",
      paymentMethod: "Payment method",
      paymentMethodValue: "•••• 4242",
      status: "Status",
      benefitsTitle: "What you get with {{plan}}",
  ...
  jobPostForm: {
    ...
    createError: "Unable to create the job post.",
  ...
  applicants: {
    ...
    rejectConfirmMessage: "Are you sure you want to reject this application? The candidate will be notified."
  },
  profile: {
    ...
    incomplete: {
      bannerTitle: "Complete the required profile details so you can publish job posts.",
      bannerSubtitle: "All required employer details must be filled in before you can create a job post.",
      homeBannerTitle: "Complete your profile to create job posts",
      homeBannerSubtitle: "Required employer details are missing.",
      cta: "Complete profile",
      missing: "Missing",
      postingLockedHint: "Publishing job posts will be enabled after you fill in the required details.",
    },
    ...
    photoTooLarge: "Image must be {{maxMb}} MB or smaller.",
    photoInvalidType: "Only JPG, PNG, and WebP images are allowed.",
    photoUploadHint: "JPG, PNG or WebP, up to {{maxMb}} MB.",
    ...
    branchUpdated: "Branch saved successfully.",
    branchUpdateError: "Failed to update branch.",
    branchDeleted: "Branch deleted successfully.",
    branchDeleteError: "Failed to delete branch.",
    branchDeleteConfirm: "Are you sure you want to delete this branch? Deletion is blocked while active job posts use this location.",
    saveBranch: "Save branch",
    deleteBranch: "Delete branch",
    confirmDeleteBranch: "Confirm delete",
